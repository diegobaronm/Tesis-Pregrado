...
\end{eqnarray}
Esto es el producto de funciones de 2-puntos:
\begin{equation}
...
\begin{equation}
\frac{\int\mathcal{D}\phi\text{Exp}\left(iS+\int J\phi dx\right)}{\int\mathcal{D}\phi\text{Exp}\left(iS\right)}
\end{equation}
...
\begin{equation}
\frac{1}{i}\frac{\delta Z_{0}[J]}{\delta J(x)}=-\int\triangle_{F}(x-y)J(y)dy\text{Exp}\left\{ \frac{-i}{2}\int J\triangle_{F}Jdxdy\right\} 
\end{equation}
...
\end{eqnarray}
Restando estas últimas dos ecuaciones obtenmos:
\begin{equation}
...
\begin{equation}
\triangle(\sqrt{x^{\prime2}+y^{\prime2}})\int\delta(y^{\prime})d\theta=1
\end{equation}
Viendo la expresión (2.222) como la identidad, insertamos esta en (2.211), lo cual nos lleva a:
\begin{equation}
I=\int d\theta \int dx^{\prime}dy^{\prime}\ e^{-(x^{\prime 2}+y^{\prime 2})}\triangle(\sqrt{x^{\prime2}+y^{\prime2}})\int\delta(y^{\prime})
\end{equation}
...
\begin{equation}
A_{\mu}^{\prime a}=A_{\mu}^{a}+f^{abc}A_{\mu}^{b}\Lambda^{c}+\partial_{\mu}\Lambda^{a}
\end{equation}
...
\begin{equation}
det(iM)=\int\mathcal{D}\bar{\eta}\mathcal{D}\eta\text{Exp}\left\{ -i\int\bar{\eta}^{a}M_{ab}\eta^{b}dx\right\} 
\end{equation}
...
\begin{equation}
\text{Exp}\left\{ -\frac{i}{2\alpha}\int C_{a}^{2}(x)dx\right\} 
\end{equation}
Y con esto obtenemos la forma final de $Z$:
\begin{equation}
Z=\mathcal{N}\int\mathcal{D}A_{\mu}\mathcal{D}\bar{\eta}\mathcal{D}\eta\text{Exp}\left\{ i\int[\mathcal{L}-\frac{F^{2}}{2\alpha}-\bar{\eta}^aM_{ab}\eta^{b}]dx\right\} 
\end{equation}
Donde $\mathcal{N}$ es un factor de normalización irrelevante. La ecuación (2.243) puede ser reescrita como:
\begin{equation}
Z=\mathcal{N}\int\mathcal{D}A_{\mu}\mathcal{D}\bar{\eta}\mathcal{D}\eta\text{Exp}\left\{ i\int\mathcal{L}_{\text{eff}}dx\right\}
\end{equation}
